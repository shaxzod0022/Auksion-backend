...
const { createProtocol, createManualProtocol, getProtocols, getUserProtocols, updateProtocolStatus, downloadProtocolPDF, deleteProtocol, getProtocolVerify } = require("../controller/protocol.controller");
